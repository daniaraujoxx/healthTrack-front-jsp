  ...
  <body>
    ...
    <main>
            ...
            <div class="row">
              <select class="form-select">
                ...
                <h2 class="col pt-2 pb-1 my-auto text-center">
                    <span id="text-variacao">Variação desde a última medição</span>
                    <br><span id="qtdvariacao">-5.8kg<i class="fas fa-apple-alt"></i></span> 
                </h2>
              ...
              <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#meses">
                <div class="accordion-body px-0 py-0">
                    <ul class="list-group d-flex justify-content-between">
                        <li class="list-group-item d-flex justify-content-between"><span class="dtpeso">29/06/2021</span> 
                          <span class="pesodia">70.0 kg</span>
                          <span class="editremove"><i class="fas fa-edit"></i><i class="far fa-times-circle"></i></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between"><span class="dtpeso">25/06/2021</span>
                          <span class="pesodia">75.8 kg</span>
                          <span class="editremove"><i class="fas fa-edit"></i><i class="far fa-times-circle"></i></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between"><span class="dtpeso">22/06/2021 </span>
                          <span class="pesodia">77.2 kg</span>
                          <span class="editremove"><i class="fas fa-edit"></i><i class="far fa-times-circle"></i></span>
                        </li>
                      </ul>
                    </div>
        ...
        <div class="d-flex justify-content-center">
          <a href="addpeso.jsp" id="btn-add" class="btn btn-warning">Adicionar</a>
        </div>
    </main>
